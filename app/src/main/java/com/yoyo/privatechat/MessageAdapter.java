...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.H> {
    ...
    @NonNull @Override public H onCreateViewHolder(@NonNull ViewGroup p,int vt){
        ...
        outer.addView(bubble,new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT));
    ...
    static class H extends RecyclerView.ViewHolder{
        LinearLayout bubble;
        TextView msg,meta;
        H(View v,LinearLayout b,TextView m,TextView t){super(v);bubble=b;msg=m;meta=t;}
    }
}
